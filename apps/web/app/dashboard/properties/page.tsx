...
export default function MyPropertiesPage() {
  ...
  return <>
    ...
    {loading && !data ? <div role="status" className="mt-6 space-y-4">{[0, 1, 2].map((n) => <div key={n} className="flex h-[130px] flex-col justify-center border border-line bg-white p-5"><div className="flex justify-between"><div className="space-y-3"><div className="h-5 w-48 animate-pulse rounded-[2px] bg-paper" /><div className="h-4 w-32 animate-pulse rounded-[2px] bg-paper" /><div className="h-4 w-24 animate-pulse rounded-[2px] bg-paper" /></div><div className="h-6 w-20 animate-pulse rounded-[2px] bg-paper" /></div></div>)}</div>
